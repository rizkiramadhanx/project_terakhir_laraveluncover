...
@section('content')
<!-- MEMBER LIST -->
<section id="member-list" class="py-5 bg-light text-text-center">
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <h1>Member List</h1>
                <hr class="w-25">
                <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. In, dolor quaerat quasi aspernatur porro neque unde iure, suscipit nostrum asperiores voluptatibus labore eveniet eaque quis amet blanditiis rem, voluptates distinctio?</p>

                <!-- Flash untuk Message -->
                @if (session()->has('pesan'))
                @if (session()->has('pesan') == 'update')
                <div class="alert alert-succes alert-dismissible w-50 mx-auto fade show">
                    Data <b>{{session()->get('nama')}}</b> berhasil di update <button type="button" class="close" data-dismiss="alert">
                        <span>&times;</span>
                    </button>
                </div>
                @endif
        ...
        <div class="card-columns text-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- tombol edit untuk admin menggunakn policy -->
                    @can('update',$user)
